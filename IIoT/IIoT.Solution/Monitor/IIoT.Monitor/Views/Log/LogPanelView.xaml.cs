// ══════════════════════════════════════════════════════════
//  IIoT.Monitor · Views/Log/LogPanelView.xaml.cs
//  역할: [로그] 탭 코드비하인드
//        LogManager.Instance.LogAdded 이벤트 구독 → ListView 표시
//        Studio-P04 / Collector Col-Base-0 LogPanelView.xaml.cs 패턴 그대로 포팅
//        (네임스페이스만 IIoT.Monitor.Views.Log 로 변경)
//
...
namespace IIoT.Monitor.Views.Log;
