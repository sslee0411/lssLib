// ══════════════════════════════════════════════════════════
//  IIoT.Manager · ViewModels/ManagerMainViewModel.cs
...
/// DispatcherTimer(2초)로 각 카드의 Refresh() 를 호출한다.
    ...
    public async Task InitializeAsync()
    {
        ...
        try
        {
            ...
            foreach (var info in _settingsLoader.Settings.Processes)
                Processes.Add(new ProcessCardViewModel(info, _processManager, _healthCheck));
